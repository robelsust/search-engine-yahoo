 ...
 */
class YahooUrl extends Url implements YahooUrlInterface
{
    use YahooUrlTrait;
    ...
    public function setPage($pageNumber)
    {
        ...
        if ($pageNumber <= 0) {
            ...
            $this->setParam('b', $pageNumber * $this->getResultsPerPage());
        }
        return $this;
    }
